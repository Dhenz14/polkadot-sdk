...
impl<'a> From<LiteP2pProtocol<'a>> for Protocol<'a> {
	fn from(protocol: LiteP2pProtocol<'a>) -> Self {
		match protocol {
			...
			LiteP2pProtocol::P2p(peer_id) => Protocol::P2p(peer_id),
			...
			LiteP2pProtocol::Ipcidr(u8) => Protocol::Ipcidr(u8),
			LiteP2pProtocol::Garlic64(str) => Protocol::Garlic64(str),
			LiteP2pProtocol::Garlic32(str) => Protocol::Garlic32(str),
...
impl<'a> From<Protocol<'a>> for LiteP2pProtocol<'a> {
	fn from(protocol: Protocol<'a>) -> Self {
		match protocol {
			...
			Protocol::P2p(peer_id) => LiteP2pProtocol::P2p(peer_id),
			...
			Protocol::Ipcidr(u8) => LiteP2pProtocol::Ipcidr(u8),
			Protocol::Garlic64(str) => LiteP2pProtocol::Garlic64(str),
			Protocol::Garlic32(str) => LiteP2pProtocol::Garlic32(str),
